...
def get_response(file_name):
    ...
    client = boto3.client('textract', aws_access_key_id="AKIA6MZEBQT4UH5YZBJ7", aws_secret_access_key="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", region_name="ca-central-1")
...
if __name__ == "__main__":
    file_name = "./veggie-grocery-receipt_orig.jpeg"
    main(file_name)
